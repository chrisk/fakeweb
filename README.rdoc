...
{<img src="https://travis-ci.org/chrisk/fakeweb.png?branch=master" alt="Build Status" align="text-top" />}[https://travis-ci.org/chrisk/fakeweb] FakeWeb's tests run at https://travis-ci.org/chrisk/fakeweb.
