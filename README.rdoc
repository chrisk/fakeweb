...
improvements, JRuby support, and a few new features. To get it, install
the latest gem directly from GitHub (currently 1.1.2.6):
...
for that release here:
http://github.com/chrisk/fakeweb/blob/ff14175b8f5478fbf0b3ca74da47db582be472cd/README.rdoc
